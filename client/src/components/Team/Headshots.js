...
function Headshots () {
    ...
    return (
        ...
        <div className="theteam">
            ...
            <img src="Laura.jpg" class="rounded-circle" alt="Sacramento Management"></img>
            ...
            {/* <img src="Kaitlin.jpg" class="rounded-circle" alt="HOA's"></img> */}
            ...
            {/* <img src="cesar.jpg" class="rounded-circle" alt="HOA MANAGEMENT"></img> */}
            ...
            {/* <img src="DeeAnn.jpg" class="rounded-circle" alt="monitoring contractors"></img> */}
            ...
            {/* <img src="Jack.jpg" class="rounded-circle" alt="Homeowners"></img> */}
        </div>
    );
}
